...
$(TARGET): $(SRC)/$(TARGET).cpp leitor.o cp_info.o method_info.o #attribute_info.o
	$(CXX) $(CFLAGS) -o $(TARGET) $(SRC)/$(TARGET).cpp leitor.o cp_info.o method_info.o #attribute_info.o
